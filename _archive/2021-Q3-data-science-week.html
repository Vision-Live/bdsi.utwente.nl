---
title: Data Science week - Summer 2021
layout: default
    ...
    > -->
        ...
        <div class="row">
            ...
            >
                <h4>
                    <a
                        href="{% link _events/workshops/2021-09-21_tidy-data-wrangling.md %}"
            ...
            <div class="col-xl-4 col-lg-6 col-12 mt-4">
                <h4>
                    <a
                        href="{% link _events/workshops/2021-09-23_machine-learning.md %}"
            ...
            >
                <h4>
                    <a
                        href="{% link _events/workshops/2021-09-24_data-visualization.md %}"
